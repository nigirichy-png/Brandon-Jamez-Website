...
export default async function SubscriberPage() {
  ...
  return <main id="main-content" className="platform-page platform-subscriber-page flex-1">
    <header className="platform-page-header platform-subscriber-header"><div className="platform-shell platform-subscriber-header-grid"><div><div className="platform-member-label"><span>Member area</span><b>18+</b></div><h1 className="platform-title">Your private <span>Pattaya feed.</span></h1><p className="platform-copy">Welcome, {state.displayName ?? "Member"}. Raw videos, private images, special events and unfiltered moments—kept inside one protected space.</p><div className="platform-member-tags"><span>Raw video</span><span>Private images</span><span>Special events</span></div></div><aside className="platform-member-status"><small>Access status</small><strong>Member access active</strong><p>Your paid access and age verification have been confirmed.</p><Link href="/account" className="platform-button-secondary">Manage account</Link></aside></div></header>
