...
export default async function VideosPage() {
  ...
  return <main id="main-content" className="platform-page flex-1"><header className="platform-shell platform-page-header platform-video-page-header py-9 sm:py-11"><p className="platform-kicker">Videos · Pattaya</p><h1 className="platform-title">Watch Brandon&apos;s latest.</h1><p className="platform-copy">Livestreams, highlights and real moments published across YouTube, Rumble and Kick.</p></header><section className="platform-shell py-8 sm:py-10" aria-label="Published videos">{loadFailed ? <div role="alert" className="platform-alert"><h2>Videos unavailable</h2><p>The published collection could not be loaded safely. Try again later.</p></div> : <PublicVideoCollection videos={videos} />}</section></main>;
}
